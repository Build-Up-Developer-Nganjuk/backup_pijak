...
import type { ForecastResponse } from "../types/smartseller";
...
export const ForecastOutput: React.FC<ForecastOutputProps> = ({ data, streamText }) => {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className={getCardClass("stream", "bg-slate-900/40 border border-slate-800 rounded-2xl p-5")}>
        ...
        <div className={`${expandedCard === "stream" ? "h-[80vh]" : "h-56"} overflow-y-auto pr-2`}>
          {!streamText ? (
            <div className="flex items-center justify-center h-full text-slate-500 text-xs italic">Menunggu hasil analisis...</div>
          ) : (
